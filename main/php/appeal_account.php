...
if (!$appeal || $appeal['appeal_type'] !== 'account') {
    header('Location: appeals.php');
    exit;
}
?>
...
<head>
    ...
    <title>Account Appeal #<?php echo (int)$appeal['id']; ?> — Meta Shark</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .pill { display: inline-flex; align-items: center; gap: 6px; padding: 4px 10px; border-radius: 12px; font-size: 12px; font-weight: 700; background: rgba(255,193,7,0.12); color: #c48a00; }
...
<body>
    <div class="card">
        <div style="display:flex; justify-content: space-between; align-items: center;">
            <h1>Account Appeal #<?php echo (int)$appeal['id']; ?></h1>
            <span class="pill">Account Appeal</span>
        </div>
        <div class="section">
