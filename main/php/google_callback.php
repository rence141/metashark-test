...
use Google\Service\Oauth2 as Google_Service_Oauth2; // ✅ Add this
...
if (isset($_GET['code'])) { 
    ...
    $oauth = new Google_Service_Oauth2($client); // ✅ Now recognized
    ...
    header("Location: http://localhost/SaysonCotest/main/php/google_login_process.php"); 
    exit; 
} else { 
